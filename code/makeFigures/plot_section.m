...
clearvars -except AMSR2 profiles wvdata metData transect
close all

saveFigs = true;
saveDir = [userpath, '/meltwaterAdvection/figures/fig5/'];
...
defineSODAconstants;
load AMSR2_2018.mat %Sea ice concentration will be included in maps of profile locations
