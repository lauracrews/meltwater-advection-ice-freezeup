...
close all; 
clearvars -except AMSR2 profiles wvdata metData ug vg lon_sub lat_sub
...
openfig([userpath, '/meltwaterAdvection/figures/fig7/DOT_geostrophic.fig'])
...
if makeAnimation
    cd('/Users/lcrews/Documents/MATLAB/SODA/finalFigures/animations/')
    v1 = VideoWriter('frontTracking_combined_ekmanDepth10m_test.mp4', 'MPEG-4'); %
