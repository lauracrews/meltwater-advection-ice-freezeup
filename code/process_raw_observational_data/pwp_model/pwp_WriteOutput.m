...
zmld(nn) = z(mld);         % Record the mixed layer depth
...
if rem(it,tintv)==0
  ...
  nntime = [nntime ntime/tintv];
	% Print the results on the screen - Laura turned this off
	% fprintf('%6.0f %6.2f %6.2f %6.0f %6.1f %6.1f %6.1f\n',...
	% 100*(it)/length(time),T(1),S(1),mld*dz,...
	% nstin,nbri,ngri);
